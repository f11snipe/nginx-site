$(function(){var a,s,i,p=[],u=["wtf is going on","how did this console get here?","hopefully i can turn it off..."],r="/var/log/nginx",o=1e3,n=1e3,l="f11snipe",c="nginx",m=[{gid:0,name:"root"}],d=[{gid:n,name:l},{gid:1001,name:"web"}],h="x86_64",g="5.13.0-1022-aws",f="Linux",v="GNU/Linux",w=h,y=h,k=f+` ${c} ${g} #24~20.04.1-Ubuntu SMP Thu Apr 7 22:10:15 UTC 2022 ${w} ${h} ${y} `+v,b=`
usage: sudo -h | -K | -k | -V
